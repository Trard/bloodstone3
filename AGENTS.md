...
- When the user asks to add or update a logo PNG, ensure it is scaled down to a standard width of 255 pixels (keeping the aspect ratio) and documented in `assets/logo/README.md`.
